...
class ReduceProcess extends Processor implements Types
{
    /**
     * プレイヤーの所持金を減らす
    ...
    */
    public static function run($player, $money, $reason, $by, $type, $db) : bool
    {
        ...
        Server::getInstance()->getPluginManager()->callEvent($result = new MoneyChangeEvent($player, $money, $reason, $by, self::TYPE_REDUCE));
        Server::getInstance()->getPluginManager()->callEvent($result2 = new MoneyReduceEvent($player, $money, $reason, $by));
